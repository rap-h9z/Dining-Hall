...
class Transaction
{
    ...
    public:
    Trasaction(int tid=0,strign trackcode=" ",float amount=0.00,TransactionType type,TransactionStatus status,time_t careatedat);
    //setters
    ...
    void setcreatedat(time_t time){_ctreatedat=time;}
